...
class StylistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stylist" do
    assert_difference('Stylist.count') do
      post stylists_url, params: { stylist: { bio: @stylist.bio, first_name: @stylist.first_name, last_name: @stylist.last_name } }
    end
  ...
  test "should update stylist" do
    patch stylist_url(@stylist), params: { stylist: { bio: @stylist.bio, first_name: @stylist.first_name, last_name: @stylist.last_name } }
